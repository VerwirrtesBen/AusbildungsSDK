...
Dies ist eine Typescript SDK zur einfachen Nutzung der Folgen APIs von Andreas Fischer und der Agentur für Arbeit
...
Das die Methode getAngebote() (Ausbildungen) &ndash; bzw. getsAngebote() (Studienangebte) des Objektes AngeboteProvider gibt ein Objekt zurück. Dieses enthält ein Page (getPage()) Objekt mit Meta informationen, einen Status (getStatus()) und Liste mit Angebot-Objekten (getAngebotListe).
